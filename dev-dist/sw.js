...
define(['./workbox-137dedbd'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "index.html",
    "revision": "0.ers5606btto"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https?:\/\/.*\/api\/cavi-groups.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/cavi-calculations.*/i, new workbox.NetworkFirst({
